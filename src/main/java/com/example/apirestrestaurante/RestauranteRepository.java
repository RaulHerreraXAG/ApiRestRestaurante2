...
public interface RestauranteRepository extends JpaRepository<Restaurante, Long> {
     ...
     *
     * @param estrellas de los restaurantes a buscar.
     * @return Lista de restaurantes con la estrellas.
     */
    List<Restaurante> getRestaurantesByEstrellas(Integer estrellas);

    /**
     * Obtiene un restaurante por su Lugar.
     *
     * @param lugar Ubicación del restaurante.
     * @return El restaurante en la Lugar proporcionada.
     */
    Restaurante getRestauranteByLugar(String lugar);

    /**
     * Obtiene una lista de restaurantes por el tipo de comida que ofrecen.
     *
     * @param gastronomia Tipo de Gastronomia que ofrecen los restaurantes.
     * @return Lista de restaurantes con el tipo de Gastronomia proporcionado.
     */
    List<Restaurante> getRestauranteByGastronomia(String gastronomia);
     ...
     *
     * @param estrellas Puntuación mínima de los restaurantes a buscar.
     * @return Lista de restaurantes con una puntuación igual o mayor a la proporcionada.
     */
    @Query("SELECT r FROM Restaurante r WHERE r.estrellas >= :estrellas")
    List<Restaurante> getRestaurantesConEstrellasMayorOIgual(Integer estrellas);
